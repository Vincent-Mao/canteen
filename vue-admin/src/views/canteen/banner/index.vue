    ...
    <div class="app-container">
        ...
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="菜品" prop="dishesId">
                <el-select style="width: 200px;" v-model="queryParams.dishesId" placeholder='请选择菜品' filterable>
                    <el-option
        ...
        <vxe-modal :title="title" v-model="open" width="500px" show-maximize showFooter resize>
            <el-form ref="bannerRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="菜品" prop="dishesId">
                    <el-select v-model="form.dishesId" placeholder='请选择菜品' filterable>
                        <el-option
                            v-for="item in dishesList"
                            :key="item.dishesId"
                            :label="item.name"
...
import {listBanner, getBanner, delBanner, addBanner, updateBanner} from "@/api/canteen/banner"
import {getToken} from "@/utils/auth.js";
import {selectAllDishes} from "@/api/canteen/dishes.js";
...
/** 导出按钮操作 */
const handleExport = () => {
    proxy.download('canteen/banner/export', {
        ...queryParams.value
