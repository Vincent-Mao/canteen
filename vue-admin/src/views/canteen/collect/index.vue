<template>
    <div class="app-container">
        ...
        <el-table @row-click="clickRow" ref="table" highlight-current-row
                  border v-loading="loading" :data="collectList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="收藏用户" align="center" prop="userName"/>
...
import {listCollect, getCollect, delCollect, addCollect, updateCollect} from "@/api/canteen/collect"
...
const handleUpdate = (row) => {
    ...
    getCollect(_collectId).then(response => {
...
/** 导出按钮操作 */
const handleExport = () => {
    proxy.download('canteen/collect/export', {
        ...queryParams.value
